...
`,[U("strong",`
 ...
 `,[F("+",[w("upload-file-list","margin-top: 8px;")]),U("disabled",`
 ...
 opacity: 1;
 transition: opacity .3s var(--n-bezier);
 `,[F("a, img","outline: none;"),U("disabled",`
 opacity: var(--n-item-disabled-opacity);
 cursor: not-allowed;
 ...
 border-radius: var(--n-border-radius);
 `,[Ae(),w("progress",[Ae({foldPadding:!0})]),F("&:hover",`
 ...
 content: "";
 `),F("&:hover",[F("&::before","opacity: 1;"),w("upload-file-info",[J("thumbnail","opacity: .12;")])])]),U("error-status",[F("&:hover",`
 ...
 opacity: 0;
 `,[w("button",[F("&:not(:last-child)",{marginRight:"4px"}),w("base-icon",[F("svg",[Yt()])])]),U("image-type",`
 position: relative;
 max-width: 80px;
 width: auto;
 `),U("image-card-type",`
