import{d as Y,r as E,aP as ut,aQ as vt,m as f,aU as Ce,bE as gt,bF as oe,bG as ht,K as u,L as o,Q as mt,O as n,M as y,P as xt,bg as yt,T as ke,R as ne,aH as wt,b as U,W as Be,X as F,au as G,a0 as Ee,bH as zt,V as L,J as Ct,a5 as St,s as Le,bI as Rt,ag as $t,F as Tt,Z as Pt,Y as _t,bl as Wt,b0 as kt,bn as Se,bx as pe,aF as Bt,x as ue,a9 as Et,a6 as M,bJ as Lt,bc as At,aT as Re,bK as jt,a8 as ve,ah as It,ai as Ot,bL as Ht,af as Ft}from"./index-6f6fc213.js";import{g as K}from"./index-567e13ca.js";import{A as Mt}from"./Add-ef61ed9f.js";const Dt=Ce(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Ce("&::-webkit-scrollbar",{width:0,height:0})]),Vt=Y({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=E(null);function r(c){!(c.currentTarget.offsetWidth<c.currentTarget.scrollWidth)||c.deltaY===0||(c.currentTarget.scrollLeft+=c.deltaY+c.deltaX,c.preventDefault())}const d=ut();return Dt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:vt,ssr:d}),Object.assign({selfRef:e,handleWheel:r},{scrollTo(...c){var x;(x=e.value)===null||x===void 0||x.scrollTo(...c)}})},render(){return f("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Nt=/\s/;function Ut(e){for(var r=e.length;r--&&Nt.test(e.charAt(r)););return r}var Xt=/^\s+/;function Gt(e){return e&&e.slice(0,Ut(e)+1).replace(Xt,"")}var $e=0/0,Kt=/^[-+]0x[0-9a-f]+$/i,Yt=/^0b[01]+$/i,Jt=/^0o[0-7]+$/i,qt=parseInt;function Te(e){if(typeof e=="number")return e;if(gt(e))return $e;if(oe(e)){var r=typeof e.valueOf=="function"?e.valueOf():e;e=oe(r)?r+"":r}if(typeof e!="string")return e===0?e:+e;e=Gt(e);var d=Yt.test(e);return d||Jt.test(e)?qt(e.slice(2),d?2:8):Kt.test(e)?$e:+e}var Qt=function(){return ht.Date.now()};const ge=Qt;var Zt="Expected a function",ea=Math.max,ta=Math.min;function aa(e,r,d){var i,c,x,h,g,v,l=0,w=!1,C=!1,z=!0;if(typeof e!="function")throw new TypeError(Zt);r=Te(r)||0,oe(d)&&(w=!!d.leading,C="maxWait"in d,x=C?ea(Te(d.maxWait)||0,r):x,z="trailing"in d?!!d.trailing:z);function S(p){var T=i,I=c;return i=c=void 0,l=p,h=e.apply(I,T),h}function R(p){return l=p,g=setTimeout(W,r),w?S(p):h}function _(p){var T=p-v,I=p-l,H=r-T;return C?ta(H,x-I):H}function P(p){var T=p-v,I=p-l;return v===void 0||T>=r||T<0||C&&I>=x}function W(){var p=ge();if(P(p))return $(p);g=setTimeout(W,_(p))}function $(p){return g=void 0,z&&i?S(p):(i=c=void 0,h)}function k(){g!==void 0&&clearTimeout(g),l=0,i=v=c=g=void 0}function A(){return g===void 0?h:$(ge())}function m(){var p=ge(),T=P(p);if(i=arguments,c=this,v=p,T){if(g===void 0)return R(v);if(C)return clearTimeout(g),g=setTimeout(W,r),S(v)}return g===void 0&&(g=setTimeout(W,r)),h}return m.cancel=k,m.flush=A,m}var ra="Expected a function";function he(e,r,d){var i=!0,c=!0;if(typeof e!="function")throw new TypeError(ra);return oe(d)&&(i="leading"in d?!!d.leading:i,c="trailing"in d?!!d.trailing:c),aa(e,r,{leading:i,maxWait:r,trailing:c})}const oa=u([o("card",`
